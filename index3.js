...
var db = new mongodb.Db('node', new mongodb.Server("localhost", 61017), {
	w: 1
});

/*This would actually be considered an unusually high ratior of readers to writers.  A more realistic scenarion would
probably involved thousands more readers
*/
